...
public class InflexibleController_efi20ConnectionHandlerImpl implements InflexibleController_efi20ConnectionHandler {
	 ...
	 */
	public InflexibleController_efi20ConnectionHandlerImpl(Connection connection, LightSimulator service) {
		this.connection = connection;
		this.service = service;
	}

	@Override
	public void handleInstructionRevokeMessage(InstructionRevoke message) {
